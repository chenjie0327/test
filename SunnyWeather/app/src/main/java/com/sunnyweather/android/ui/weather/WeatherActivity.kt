...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.statusBarColor = Color.TRANSPARENT  //调用setstatusBarColor()方法将状态栏编程透明色
        }
        ...
        //调用SwipeRefreshingLayout的setColorSchemeResources（)方法，设置下拉刷新进度条的颜色
...
//调用WeatherViewModel的refreshWeather()方法刷新天气
    fun refreshWeather() {
